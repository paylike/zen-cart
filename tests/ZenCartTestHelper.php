...
class ZenCartTestHelper {
	...
	/**
	 * ZenCartTestHelper constructor.
	 *
	 * @param \ZenCart\ZencartFullTest $zencart_test
	 */
	public function __construct( $zencart_test ) {
		$this->main_test    = $zencart_test;
		$this->wd           = $zencart_test->wd;
