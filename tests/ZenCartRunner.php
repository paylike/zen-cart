...
class ZenCartRunner extends ZenCartTestHelper
{
    ...
    private function getVersions()
    {
        ...
        $zencart = $this->getText('.region #edit-modules-commerce .tableheader-processed tbody tr td:nth-child(2)');
        $paylike = $this->getText('.region #edit-modules-commerce-contrib .tableheader-processed tbody tr td:nth-child(2)');
